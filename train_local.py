...
parser.add_argument("--use-s3", help="Flag to download data from s3", action='store_true')
...
if args.use_s3:
    ...
    for model_weight in args.model_weights:
        ...
        local_weights_paths.append(model_weight_path)
        assert model_weight_path.is_file()
